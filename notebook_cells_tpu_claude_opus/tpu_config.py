...
=============================================================================
  ...
  - bfloat16 as TPU-native precision
...
# Model selection
# Option 1: "Qwen/Qwen2.5-72B-Instruct"  - Best quality (Kaggle TPU v3 only)
# Option 2: "Qwen/Qwen2.5-32B-Instruct"  - Works on Kaggle TPU v3
# Option 3: "Qwen/Qwen2.5-7B-Instruct"   - Fast, fits anywhere (Colab TPU v2)
...
# =============================================================================
# The repo name is derived from the clone URL.
# After cloning, WORK_DIR points to the repo root.
